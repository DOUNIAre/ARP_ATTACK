...
def process_sniffer_pkt(pkt):
   print("writing the pcap file. Press ctrl + c to exit.")
...
def print_arp_res(arp_res):
    ...
    while True:
       try:
          choice = int(input("Please select the ID of the computer  want to poison (ctrl+z to exit): "))
          if arp_res[choice]:
             return choice
